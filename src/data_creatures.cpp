...
Creature_t creatures_list[MON_MAX_CREATURES] = {
    ...
    {"Yellow Mushroom patch",     0x00000001L, 0x00000000L, 0x10A0,     2,   0,  2,   1, 11, ',', {  1,  1}, {100,   0,   0,   0},   2, Color_Light_Yellow},
    ...
    {"Spotted Mushroom patch",    0x00000001L, 0x00000000L, 0x10A0,     3,   0,  2,   1, 11, ',', {  1,  1}, {175,   0,   0,   0},   3, Color_Light_Grey_Low},
    ...
    {"Large Green Snake",         0x0000000AL, 0x00000000L, 0x00B2,    10,  70,  5,  40, 10, 'R', {  6,  8}, { 27,  74,   0,   0},   3, Color_Green},
    {"Radiation Eye",             0x00000001L, 0x0001000BL, 0x2100,     6,  10,  2,   6, 11, 'e', {  3,  6}, { 88,   0,   0,   0},   3, Color_Red},
    {"Drooling Harpy",            0x00000012L, 0x00000000L, 0x2034,     7,  10, 16,  22, 11, 'h', {  2,  8}, { 49,  49,  25,  79},   3, Color_Light_Grey_High},
    ...
    {"Green Glutton Ghost",       0x0F950032L, 0x0000003FL, 0x110C,    15,  10, 10,  20, 13, 'G', {  3,  6}, {211,   0,   0,   0},   5, Color_Light_Green},
    ...
    {"Bloodshot Eye",             0x00000001L, 0x00010007L, 0x2100,    15,  10,  2,   6, 11, 'e', {  4,  8}, {143,   0,   0,   0},   7, Color_Red},
    ...
    {"Bloodshot Icky-Thing",      0x00000012L, 0x0001000BL, 0x0020,    24,  20, 14,  18, 11, 'i', {  7,  8}, { 65, 139,   0,   0},   9, Color_Red},
    ...
    {"Hobgoblin",                 0x0F020002L, 0x00000000L, 0x2034,    38,  30, 20,  38, 11, 'H', { 12,  8}, {  9,   0,   0,   0},  11, Color_Light_Brown},
    {"Black Mamba",               0x00000012L, 0x00000000L, 0x00B2,    40,   1, 10,  32, 12, 'R', { 10,  8}, {163,   0,   0,   0},  12, Color_Black},
    {"Grape Jelly",               0x00000001L, 0x0001000BL, 0x11A0,    60,  99,  2,   1, 11, 'J', { 52,  8}, {186,   0,   0,   0},  12, Color_Wine},
    {"Master Yeek",               0x07020002L, 0x00008018L, 0x2030,    28,  10, 18,  24, 11, 'y', {  5,  8}, {  7,   0,   0,   0},  12, Color_Stone},
    ...
    {"Giant Red Speckled Frog",   0x0000000AL, 0x00000000L, 0x00A2,    32,  30, 12,  20, 11, 'f', {  6,  8}, { 41,   0,   0,   0},  13, Color_Red},
    ...
    {"Giant Long-Eared Bat",      0x00000012L, 0x00000000L, 0x2162,    20,  20, 12,  20, 13, 'b', {  5,  8}, { 27,  50,  50,   0},  13, Color_Light_Grey_High},
    ...
    {"Hill Giant",                0x07020002L, 0x00000000L, 0x2034,    52,  50, 20,  36, 11, 'P', { 16,  8}, { 19,   0,   0,   0},  14, Color_Light_Grey_Low},
    ...
    {"Guardian Naga",             0x1710000AL, 0x00000000L, 0x20E4,    60, 120, 20,  50, 11, 'n', { 24,  8}, { 77,  31,   0,   0},  15, Color_Medium_Grey_High},
    ...
    {"Giant Green Dragon Fly",    0x00000012L, 0x0010000AL, 0x0032,    58,  50, 20,  20, 11, 'F', {  5,  8}, {156,   0,   0,   0},  16, Color_Green},
    ...
    {"Quasit",                    0x1183000AL, 0x000010FAL, 0x1004,    48,  20, 20,  30, 11, 'q', {  5,  8}, {176,  51,  51,   0},  16, Color_Wrinkled},
    ...
    {"Killer Black Beetle",       0x0000000AL, 0x00000000L, 0x0002,    75,  30, 12,  46, 11, 'K', { 18,  8}, { 44,   0,   0,   0},  19, Color_Black},
    ...
    {"Cloud Giant",               0x07020002L, 0x00080000L, 0x2034,   125,  50, 20,  44, 11, 'P', { 24,  8}, {130,   0,   0,   0},  20, Color_Cloudy},
    ...
    {"Killer Boring Beetle",      0x0000000AL, 0x00000000L, 0x0002,    70,  30, 12,  48, 11, 'K', { 18,  8}, { 44,   0,   0,   0},  21, Color_Wooden},
    {"Killer Stag Beetle",        0x0000000AL, 0x00000000L, 0x0002,    80,  30, 12,  50, 11, 'K', { 20,  8}, { 41,  10,   0,   0},  22, Color_Brown},
    ...
    {"Shimmering Mold",           0x00000081L, 0x00080000L, 0x10A0,   180,  50,  2,  24, 11, 'm', { 32,  8}, {135,   0,   0,   0},  27, Color_Lightning},
    ...
    {"Giant Glowing Rat",         0x0020000AL, 0x00080000L, 0x2072,     4,  20,  8,  24, 11, 'r', {  3,  3}, {132,   0,   0,   0},  29, Color_Lightning},
    ...
    {"Giant Lightning Bat",       0x00000012L, 0x00080000L, 0x2042,    80,  10, 15,  34, 12, 'b', {  8,  8}, {133,  53,  53,   0},  30, Color_Lightning},
    ...
    {"Spirit Troll",              0x17150002L, 0x00000000L, 0x510C,   425,  10, 20,  40, 11, 'G', { 15,  8}, { 53,  53,  29, 185},  34, Color_Clear},
    ...
    {"Xorn",                      0x00160002L, 0x00000000L, 0x4200,   650,  10, 20,  80, 11, 'X', { 20,  8}, {  5,   5,   5,   0},  36, Color_Dark_Green},
    {"Giant Mottled Ant Lion",    0x0008000AL, 0x00000000L, 0x0032,   350,  40, 14,  50, 12, 'A', { 24,  8}, { 38,   0,   0,   0},  36, Color_Light_Grey_Low},
